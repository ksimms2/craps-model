...
public class Game {
   ...
   */
  public Game(Random rng){ // constructor
    this.rng = rng;
    rolls = new LinkedList<>();
  }

  /**
   * Prepares this instaance tp play a round&mdash; i.e. returns the game state to
   * {@link State #COME_OUT}, clears the established point, and clears the list of rolls.
   * This method <strong>must</strong> be invoked prior to {@link
   ...
   * state after {@link #reset()} is invoked, and terminal state (@link
